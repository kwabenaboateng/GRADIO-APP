    ...
    with gr.Row():
        with gr.Column(scale=3.5, min_width=500):
            input_interface = [
                ...
                gr.components.Dropdown(['Yes', 'No'], label='Do you have any Dependents?'),
                gr.components.Number(label='Length of Tenure (No. of months with Vodafone)'),
                gr.components.Radio(['Yes', 'No'], label='Do you use Phone Service?'),
                gr.components.Radio(['Yes', 'No'], label='Do you use Multiple Lines?'),
                gr.components.Radio(['DSL', 'Fiber optic', 'No'], label='Do you use Internet Service?'),
                gr.components.Radio(['Yes', 'No'], label='Do you use Online Security?'),
                gr.components.Radio(['Yes', 'No'], label='Do you use Online Backup?'),
                gr.components.Radio(['Yes', 'No'], label='Do you use Device Protection?'),
                gr.components.Radio(['Yes', 'No'], label='Do you use the Tech Support?'),
                gr.components.Radio(['Yes', 'No'], label='Do you Streaming TV?'),
                gr.components.Radio(['Yes', 'No'], label='Do you Streaming Movies?'),
